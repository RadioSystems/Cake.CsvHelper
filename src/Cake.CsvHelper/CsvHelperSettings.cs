...
namespace Cake.CsvHelper
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CsvHelperSettings"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether if comments are allowed.
        /// </summary>
        /// <value>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether changes in the column count should be detected. If true, a <see cref="BadDataException"/> will be thrown if a different column count is detected.
        /// </summary>
        /// <value>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether if the CSV file has a header record.
        /// </summary>
        public bool HasHeaderRecord { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether to ignore white space in the headers when matching the columns to the properties by name.
        /// </summary>
        public bool IgnoreHeaderWhiteSpace { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether to ignore private accessors when reading and writing. By default you can't read from a private getter or
        ...
        /// <summary>
        /// Gets or sets a value indicating whether if quotes should be ignored when parsing and treated like any other character.
        /// </summary>
        /// <value>
        ///  <c>true</c> if to ignore quotes; otherwise, <c>false</c>.
        /// </value>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether all fields are quoted when writing, or just ones that have to be. <see cref="QuoteAllFields"/> and
        /// <see cref="QuoteNoFields"/> cannot be true at the same time. Turning one on will turn the other off.
        /// </summary>
        /// <value>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether no fields are quoted when writing. <see cref="QuoteAllFields"/> and <see cref="QuoteNoFields"/> cannot be true
        ...
        /// <summary>
        /// Gets or sets a value indicating whether if the reader to ignore white space from the beginning and ending of the headers
        /// when matching the columns to the properties by name.
        /// </summary>
        public bool TrimHeaders { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether if an exception will be thrown if a field defined in a mapping is missing. True to throw an exception, otherwise false. Default is true.
        /// </summary>
        /// <value>
